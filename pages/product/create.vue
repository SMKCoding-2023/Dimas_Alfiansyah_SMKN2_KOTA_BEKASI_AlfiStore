      ...
      <form @submit.prevent="createProduct">
        ...
        >
          ...
          <input
            ...
            class="w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 focus:outline-none file:bg-slate-700 file:border-none file:px-3 file:py-2 file:text-white file:mr-3"
        ...
        <button
          type="submit"
          class="text-white bg-slate-700 hover:bg-slate-900 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
        >
